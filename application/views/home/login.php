...
<body>
  ...
  <div class="container-fluid">
    <div class="row-fluid">
      <div class="login-form well" style="margin:100px auto;text-align:center;width:300px">
        <h2>Login @ <img src="<?php global $template; echo base_url(). "application/views/layouts/" .$template. "/img/logo.jpg" ; ?>" alt="logo mariza"></h2>
        <hr>
        <form action="">
          <fieldset>
